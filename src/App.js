    ...
    <>
      <group>
        ...
        <mesh castShadow position={[(i + 1) * (imageWidth + gap) + (i + 1), 0, 0]}>
          ...
          <meshStandardMaterial attach="material" map={texture} roughness={0.2} metalness={0.8} />
        </mesh>
...
const Scene = () => {
  ...
  return (
    <Suspense
      fallback={
        <Html style={{ fontSize: "2vw", whiteSpace: "nowrap", color: "white" }} center>
